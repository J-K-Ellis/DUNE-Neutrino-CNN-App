...
class Line_Creation_Page(tk.Frame):
    """A Tkinter frame for creating and displaying line plots."""
    def __init__(self, parent, controller):
        ...
        self.Create_Fig_Button = tk.Button(  self, text='Create', command=lambda: self.controller.Generic_Plot.Create_Line_PLot(self) )
